...
class ArmsVideoInfo extends StatefulWidget {
  const ArmsVideoInfo({Key? key}) : super(key: key);

  @override
  _ArmsVideoInfoState createState() => _ArmsVideoInfoState();
}

class _ArmsVideoInfoState extends State<ArmsVideoInfo> {
  List videoInfo = [];
  ...
  void _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/armsworkout.json")
        .then((value) {
      setState(() {
