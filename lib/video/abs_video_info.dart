...
class AbsVideoInfo extends StatefulWidget {
  const AbsVideoInfo({Key? key}) : super(key: key);

  @override
  _AbsVideoInfoState createState() => _AbsVideoInfoState();
}

class _AbsVideoInfoState extends State<AbsVideoInfo> {
  List videoInfo = [];
  ...
  void _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/absworkout.json")
        .then((value) {
      setState(() {
