...
class LegsVideoInfo extends StatefulWidget {
  const LegsVideoInfo({Key? key}) : super(key: key);

  @override
  _LegsVideoInfoState createState() => _LegsVideoInfoState();
}

class _LegsVideoInfoState extends State<LegsVideoInfo> {
  List videoInfo = [];
  ...
  void _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/legsworkout.json")
        .then((value) {
      setState(() {
        ...
        body: Container(
          ...
          child: Column(
            children: [
              _playArea == false
                  ? Container(
                padding: EdgeInsets.only(top: Dimensions.height30*2, left: Dimensions.width15, right:  Dimensions.width15),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      padding:
                      EdgeInsets.only(top: Dimensions.height10*5, left: Dimensions.height30, right: Dimensions.height30),
                      child: Row(
                        children: [
                          InkWell(
                              onTap: () {
